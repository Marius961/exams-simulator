...
var snowOnAndOffAnimationTime = 150;

var snowStorm = (function(window, document) {

    // --- common properties ---
    this.autoStart = JSON.parse(localStorage.getItem('autoSnowFall'));          // Whether the snow should start automatically or not.
    ...
    this.stop = function() {
        ...
        var storm = this;
        for (i=0; i<this.flakes.length; i++) {
            $(this.flakes[i].o).fadeOut(snowOnAndOffAnimationTime);
        }
        storm.freeze();
    ...
    this.show = function() {
        var i;
        for (i=0; i<this.flakes.length; i++) {
            $(this.flakes[i].o).fadeIn(animationTime*4);
        }
    };
